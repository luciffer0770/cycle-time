...
//   operator → cyan
//   wait     → orange/red
//   optimal  → green (for value-added non-critical)
//   critical → red glow
...
export default function Gantt({
  ...
  return (
    <div className="w-full">
      {/* Timeline header */}
      <div className="relative h-6 border-b border-white/10 mb-2">
        {ticks.map((t) => (
          <div
            key={t}
        ...
        {taktTime > 0 && (
          ...
          >
            ...
            <div className="-translate-x-1/2 mt-0.5 px-1 rounded bg-critical/20 border border-critical/40">
              TAKT {taktTime}s
            </div>
          </div>
        )}
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {taktTime > 0 && (
            <div
              className="absolute top-0 bottom-0 w-px bg-critical/50 shadow-neon-red pointer-events-none"
              style={{ left: `${pct(taktTime)}%` }}
            />
          )}
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Dependency connectors (very light — small dots at start) */}
                  {(s.dependencies || []).length > 0 && (
                    <div
                      className="absolute w-1.5 h-1.5 rounded-full bg-cyan shadow-neon-cyan"
                      style={{ left: `calc(${mLeft}% - 4px)`, top: '50%', transform: 'translateY(-50%)' }}
                    />
                  )}
                  ...
                  {hoverId === s.id && (
                    <div
                      className="absolute z-10 -top-12 glass-strong px-3 py-2 rounded-md text-[11px] font-mono"
                      style={{ left: `min(${mLeft}%, calc(100% - 220px))`, minWidth: 200 }}
                    >
                ...
                {/* Right-side numeric */}
                <div className="w-24 shrink-0 text-right font-mono text-[11px] text-slate-400">
